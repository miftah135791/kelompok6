    ...
    constructor(props) {
        ...
        this.state = {
            ...
            formData: {
                ...
                nama_ayah:'',
                umur:'',
                pekerjaan_ayah:'Belum Bekerja',
                alamat_ayah:'',
            }
        }
    }
    render() {
        const { nama,no_hp, jk, tgl_lahir, Tempat_Lhr,alamat, pekerjaan,nama_ayah,umur,pekerjaan_ayah,alamat_ayah } = this.state.formData;
        return (
