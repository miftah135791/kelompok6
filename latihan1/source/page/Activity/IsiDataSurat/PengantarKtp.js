...
class App extends Component {
    ...
    render() {
        const { nama,no_hp,Nik,NoKk,GolDar, jk, tgl_lahir, Tempat_Lhr,Agama, Kewarganegaraan, Alamat, pekerjaan,status_kawin } = this.state.formData;
        return (
            <ScrollView backgroundColor=' 	#F5F5DC'>
                <KeyboardAvoidingView style={styles.container} enabled>
                    ...
                    <View style={styles.row}>
                        ...
                        <Picker
                            selectedValue={GolDar}
                            style={{ height: 50,width:200,color:'orange',fontWeight:'bold' }}
                        ...
                        >
                            {this.state.dataGolDar.map((item, index) => (
                                <Picker.Item
                                    key={index}
                                    label={item}
    ...
    _saveData = async () => {
        ...
        try {
            await fetch('http://10.0.7.69/TugasAkhir/PengantarKtp.php', {
                method: 'POST',
                headers: {
