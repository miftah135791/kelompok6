...
export default class login extends Component {
	...
	login = () => {
		...
		// }
			...
			fetch('http://10.0.7.69/TugasAkhir/LoginSekretaris.php',
				{
					method: 'post',
					header: {
	...
	render() {
		return (
				<ImageBackground source={require('../../../asset/images/BK1.jpg')} style={styles.image}>
				<View style={styles.container}>
				<StatusBar barStyle="dark-content" translucent backgroundColor="rgba(0,0,0,0)" />
					<View>
						<Text style={{ fontWeight: 'bold',marginRight:170,marginBottom:20 }}>Selamat Datang Sekretaris!</Text>
							</View>
					<TextInput
